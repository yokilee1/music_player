...
export const MovingText = ({ text, animationThreshold, style }: MovingTextProps) => {
	...
	const textWidth = text.length * 3 // Approximate width based on character count
	...
	return (
		<Animated.Text
			...
			style={[
				...
				animatedStyle,
				shouldAnimate && {
					width: 9999, // Ensure the text can scroll fully
					paddingLeft: 16, // Add some padding to the left for better visual
				},
			]}
		>
			{text}
